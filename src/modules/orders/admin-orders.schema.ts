...
export const adminOrderSelect={id:true,status:true,currency:true,total:true,createdAt:true,user:{select:{email:true,profile:{select:{firstName:true,lastName:true,phone:true}}}},_count:{select:{items:true}}} satisfies Prisma.OrderSelect;
